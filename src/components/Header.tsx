...
import { formatAddress, CHAIN_ID, CHAIN_NAME, CONTRACT_ADDRESS } from '../lib/genlayer';
...
export default function Header({ wallet, onConnectClick, onDisconnect }: HeaderProps) {
  return (
    <header className="sticky top-0 z-50 border-b border-cyan-500/10 bg-black/80 backdrop-blur-xl">
      <div className="container mx-auto px-5 max-w-7xl">
        ...
        <div className="flex items-center justify-between py-1 border-b border-white/5 text-[10px] font-mono text-white/25 tracking-wider">
          <div className="flex items-center gap-3">
            ...
            <span className="px-1.5 py-0.5 bg-cyan-400/15 text-cyan-400/70 rounded text-[9px]">
              STUDIO · ON-CHAIN
            </span>
          </div>
          <div className="flex items-center gap-4">
            ...
            <span className="hidden sm:inline">THRESHOLD: 40</span>
            <span className="hidden md:inline">CONTRACT: {formatAddress(CONTRACT_ADDRESS)}</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between py-3">
          ...
          >
            <div className="relative w-9 h-9">
              <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-cyan-400 to-fuchsia-500 opacity-20 blur-md"></div>
            ...
            <div>
              ...
              <p className="text-[10px] font-mono text-white/30 tracking-widest uppercase">
                AI Content Scanner · Contract-Authoritative
              </p>
            </div>
          </motion.div>
            ...
            {wallet.connected ? (
              ...
              >
                ...
                <div className="relative flex items-center gap-2 text-sm font-medium text-cyan-400 group-hover:text-cyan-300 transition-colors">
                  ...
                  <span className="font-mono text-xs tracking-wider">CONNECT WALLET</span>
                </div>
              </button>
            )}
          </motion.div>
